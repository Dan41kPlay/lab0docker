...
Веб-приложение работает, однако кодировку исправить не удалось
![Screenshot](Screenshot_2026-05-26_23-13-13.png "Веб-приложение работает, однако кодировку исправить не удалось")
